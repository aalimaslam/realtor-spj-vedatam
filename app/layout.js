  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <Script id="gtm-init" strategy="beforeInteractive">
          {`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            ...
            })(window,document,'script','dataLayer','GTM-TBKNMXMQ');`}
        </Script>
        {/* End Google Tag Manager */}
        {/* Google tag (gtag.js) */}
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-TWFTCZSCVS" strategy="afterInteractive" />
        <Script id="gtag-init" strategy="afterInteractive">
          {`
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
            gtag('config', 'G-TWFTCZSCVS');
          `}
        </Script>
      ...
      <body className="bg-[#130F25] text-[#EEEEEE] font-brand antialiased selection:bg-[#EBC75D] selection:text-[#130F25] overflow-x-clip">
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TBKNMXMQ"
            height="0"
            width="0"
